  ...
  render: function(){
    ...
    this.props.data.forEach(function(data, idx){
      if (data.original_title){
        ...
        <img className="movie-casting-picture" src="https://www.promaxequipment.com/static/image-unavailable.png"/> :
        <img className="movie-casting-picture" src={`https://image.tmdb.org/t/p/w92/${data.poster_path}`}/>
        ...
        <img className="movie-casting-picture" src={`https://image.tmdb.org/t/p/w92/${data.profile_path}`}/>
