  ...
  render: function(){
    ...
    this.props.data.forEach(function(data, idx){
      if (data.original_title){
        ...
        <img className="movie-casting-picture" onClick={this.showActor} src="http://www.promaxequipment.com/static/image-unavailable.png"/> :
        <img className="movie-casting-picture" src={`http://image.tmdb.org/t/p/w92/${data.poster_path}`} onClick={this.showActor}/>
        ...
        <img className="movie-casting-picture" src={`http://image.tmdb.org/t/p/w92/${data.profile_path}`} onClick={this.showActor}/>
